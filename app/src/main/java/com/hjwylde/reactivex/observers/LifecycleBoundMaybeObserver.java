...
abstract public class LifecycleBoundMaybeObserver<T> implements LifecycleObserver, MaybeObserver<T> {
    private Lifecycle mLifecycle;

    private Disposable mDisposable;
    private Lifecycle.State mBirth;

    public LifecycleBoundMaybeObserver(@NonNull LifecycleOwner owner) {
