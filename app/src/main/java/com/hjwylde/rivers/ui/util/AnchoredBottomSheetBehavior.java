...
public class AnchoredBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public AnchoredBottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null)
            mAnchorPoint = (int) a.getDimension(R.styleable.AnchoredBottomSheetBehavior_Layout_behavior_anchorPoint, 0);
        a.recycle();
     ...
     * @hide
     */
    @IntDef({STATE_EXPANDED, STATE_ANCHORED, STATE_COLLAPSED, STATE_DRAGGING, STATE_SETTLING, STATE_HIDDEN})
